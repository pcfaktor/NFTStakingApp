...
const TOKEN_NAME = "PcfaktorCoin";
const TOKEN_SYMBOL = "PCFR";
const TOKEN_DESCRIPTION = "The coolest token by Pcfaktor";
const TOKEN_IMAGE_NAME = "pcfaktor_coin.png"; // Replace unicorn.png with your image name
